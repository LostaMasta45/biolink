    ...
    <div className="space-y-6">
      ...
      <Card className="rounded-xl border-border/60">
        <CardContent className="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="space-y-2"><Label>Event</Label><Select value={eventType} onValueChange={setEventType}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="all">Semua event</SelectItem><SelectItem value="api.message.send">API Send</SelectItem><SelectItem value="api.message.status">Status Provider</SelectItem><SelectItem value="auto_reply.queued">Queued</SelectItem><SelectItem value="auto_reply.sent">Auto Reply Sent</SelectItem><SelectItem value="auto_reply.failed">Failed</SelectItem></SelectContent></Select></div>
